fn main() {
    ...
    println!(
        "Day {} part 1: {}",
        day,
        adventofcode2025::day6::part1(&input)
    );
    println!(
        "Day {} part 2: {}",
        day,
        adventofcode2025::day6::part2(&input)
    );
    ...
    println!(
        "Day {} part 1: {}",
        day,
        adventofcode2025::day7::part1(&input)
    );
    println!(
        "Day {} part 2: {}",
        day,
    ...
    println!(
        "Day {} part 1: {}",
        day,
        adventofcode2025::day9::part1(&input)
    );
    println!(
        "Day {} part 2: {}",
        day,
        adventofcode2025::day9::part2(&input)
    );
    ...
    println!(
        "Day {} part 1: {}",
        day,
        adventofcode2025::day12::part1(&input)
    );
    println!(
        "Day {} part 2: {}",
        day,
        adventofcode2025::day12::part2(&input)
    );
}
